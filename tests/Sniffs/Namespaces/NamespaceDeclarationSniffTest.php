...
class NamespaceDeclarationSniffTest extends \SlevomatCodingStandard\Sniffs\TestCase
{
	...
	public function testInvalidWhitespaceAfterNamespaceErrors()
	{
		...
		self::assertSniffError($report, 3, NamespaceDeclarationSniff::CODE_INVALID_WHITESPACE_AFTER_NAMESPACE, 'Expected one space after namespace statement, found 5.');
		self::assertSniffError($report, 5, NamespaceDeclarationSniff::CODE_INVALID_WHITESPACE_AFTER_NAMESPACE, 'Expected one space after namespace statement, found tab.');
		self::assertSniffError($report, 7, NamespaceDeclarationSniff::CODE_INVALID_WHITESPACE_AFTER_NAMESPACE, 'Expected one space after namespace statement.');
