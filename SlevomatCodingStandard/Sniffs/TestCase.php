...
abstract class TestCase extends \PHPUnit\Framework\TestCase
{
	...
	protected static function assertNoSniffErrorInFile(File $file)
	{
		$errors = $file->getErrors();
		self::assertEmpty($errors, sprintf('No errors expected, but %d errors found.', count($errors)));
	}

	protected static function assertSniffError(File $codeSnifferFile, int $line, string $code, string $message = null)
	{
	...
	protected static function assertNoSniffError(File $codeSnifferFile, int $line)
	{
		$errors = $codeSnifferFile->getErrors();
		self::assertFalse(
			isset($errors[$line]),
	...
	protected static function assertAllFixedInFile(File $codeSnifferFile)
	{
